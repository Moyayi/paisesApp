export interface SearchedRegions {
    data?: RegionInterfaz
}

export interface RegionInterfaz {
    name:         Name;
    tld:          string[];
    cca2:         string;
    ccn3:         string;
...
export class Convert {
    public static toRegionInterfaz(json: string): RegionInterfaz {
        return cast(JSON.parse(json), r("RegionInterfaz"));
    }

    public static RegionInterfazToJson(value: RegionInterfaz): string {
        return JSON.stringify(uncast(value, r("RegionInterfaz")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "NativeName": o([
        { json: "bar", js: "bar", typ: r("Translation") },
    ], false),
    "Translation": o([
        { json: "official", js: "official", typ: "" },
        { json: "common", js: "common", typ: "" },
